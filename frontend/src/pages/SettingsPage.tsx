              ...
              <div key={field} className={styles.inputGroup}>
                ...
                <div className={styles.inputRow}>
                  ...
                  <button
                    ...
                    onClick={() =>
                      alert(field === "password" ? "Пароль збережено" : `${field === "email" ? "Email" : "Телефон"} збережено: ${settings[field as keyof SettingsData]}`)
                    }
                  >
          ...
          <li key={device.id} className={styles.deviceItem}>
            ...
            {index === 0 && settings.activeDevices.length > 1 && (
              <button
                ...
                onClick={() =>
                  updateSetting("activeDevices", [settings.activeDevices[0]])
                }
              >
